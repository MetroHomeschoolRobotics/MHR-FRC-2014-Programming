...
private:
	...
	bool AutoShot(double distance = 1, double power = 1, bool instantRetract = false, double shotWait = 0) {
		bool end;
...
*/	
	//redLED->SetSafetyEnabled(false);
	//greenLED->SetSafetyEnabled(false);
	//blueLED->SetSafetyEnabled(false);
	//if(DriverPad->GetRawButton(1))
